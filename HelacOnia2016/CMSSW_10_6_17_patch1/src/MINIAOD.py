...
def _read_runtime_options(argv):
    options = {
        "inputRECO": "file:BPH-RECO-13TeV.root",
        "outputMINIAOD": "file:BPH-MiniAOD-13TeV.root",
        "maxEvents": -1,
        "skipEvents": 0,
    }
...
process.source = cms.Source(
    "PoolSource",
    fileNames=cms.untracked.vstring(runtime_options["inputRECO"]),
...
process.MINIAODSIMoutput = cms.OutputModule(
    ...
    fileName=cms.untracked.string(runtime_options["outputMINIAOD"]),
